...
class Engine(object):
    def __init__(self, scene_map):
        self.scene_map = scene_map #scene_map is-a Map class
...
class LaserWeaponArmory(Scene):
    def enter(self):
        ...
        cheat_code = input("[Cheat?]> ")
        if cheat_code  == "yes":
            print("You Cheater!: %d " % int(code))
        else:
            print("Good boy!")
        guess = input("[keypad]> ")
        guesses = 0
...
class EscapePod(Scene):
    def enter(self):
        ...
        cheat_pod = input("[Cheat?]> ")
        if cheat_pod  == "yes":
            print("You Cheater!: %d " % int(good_pod))
        else:
            print("good boy")
        guess = input("[pod #]> ")
...
class Map(object):
    #scenes is a dictionary - key:son-classes of Scene; value:
    scenes = {
        'central_corridor': CentralCorridor(), #CentrolCorridor Class
        'laser_weapon_armory': LaserWeaponArmory(), #LaserWeaponArmory Class
        'the_bridge': TheBridge(), #TheBridge Class
        'escape_pod': EscapePod(), #EscapePod Class
        'death': Death(), #Death Class
    ...
    def next_scene(self, scene_name):
        return Map.scenes.get(scene_name) #method in dictonary: get(key) return the value of that key
